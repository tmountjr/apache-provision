...
module.exports = {
	...
	// confPath: '/etc/apache2/sites-available',	// puppet will destroy this directory on provision.
	...
	setEnabledConfPath: function(enabledConfPath) {
		this.enabledConfPath = path.normalize(enabledConfPath);
	},
	...
	template: {
		...
		link: function(folderName) {
			var confName = module.exports.getSerializedConfName(folderName),
				src = path.join(module.exports.confPath, confName),
				target = path.join(module.exports.enabledConfPath, confName);
